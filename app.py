...
@app.callback(
    ...
    [State("led-select", "value"), State("color-slide", "children")],
)
def colorpick(
    value_all,
    value_individual,
...
@app.callback(
    ...
    [Input("color-picker", "value"), Input("all-switch", "on")],
)
...
@app.callback(
    ...
    [Input("color-picker", "value"), Input("led-select", "value")],
)
...
# Led Rainbow Switch
@app.callback(Output("color-rainbow", "children"), [Input("rainbow-switch", "on")])
...
@app.callback(
    ...
    [Input("led-slide", "value"), Input("color-picker", "value")],
    [
        State("all-switch", "on"),
...
def led_slide(slide, value, all_switch, rainbow_switch, led_select):
...
def color_off(rainbow_switch, all_switch, led_select, led_slide, power):
    if (
        rainbow_switch == False
        and all_switch == False
        and led_select == 0
        and led_slide == 0
    ):
        bstick.set_color(0, 0, 0, 0, 0)
...
# Color Picker
@app.callback(Output("led-slide", "color"), [Input("color-picker", "value")])
...
@app.callback(Output("power", "color"), [Input("color-picker", "value")])
def color_picker(value):
    r = value["rgb"]["r"]
    b = value["rgb"]["g"]
    g = value["rgb"]["b"]
...
@app.callback(Output("rainbow-switch", "color"), [Input("color-picker", "value")])
def color_picker(value):
    r = value["rgb"]["r"]
    b = value["rgb"]["g"]
    g = value["rgb"]["b"]
...
@app.callback(Output("all-switch", "color"), [Input("color-picker", "value")])
def color_picker(value):
    r = value["rgb"]["r"]
    b = value["rgb"]["g"]
    g = value["rgb"]["b"]
...
@app.callback(Output("color-return", "children"), [Input("color-picker", "value")])
def color_picker(value):
    r = value["rgb"]["r"]
    b = value["rgb"]["g"]
    g = value["rgb"]["b"]
...
@app.callback(Output("container", "style"), [Input("color-return", "children")])
...
@app.callback(Output("LED-PANEL", "style"), [Input("color-return", "children")])
def color_picker(color):
...
@app.callback(
    ...
    [Input("led-slide", "value"), Input("led-select", "value")],
)
...
@app.callback(Output("led-slide", "disabled"), [Input("led-select", "value")])
...
@app.callback(Output("led-select", "disabled"), [Input("led-slide", "value")])
