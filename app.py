                ...
                html.Div(
                    [
                        daq.Slider(
                            ...
                            color="",
                            handleLabel={
                                "showCurrentValue": "True", "label": "LED"},
                            size=638,
                            min=0,
                            max=8,
                            marks={"0": "OFF",
...
def colorpick(value_all, value_individual, power, rainbow, led_slide, all_switch, led_select, color_slide):
    if power == False:
